...
/** Goal: Validate update request for DataTimbangIndodaya, Caller: ApiDataTimbangIndodayaController, Deps: none */

use Illuminate\Foundation\Http\FormRequest;

class UpdateDataTimbangIndodayaRequest extends FormRequest
{
    /**
