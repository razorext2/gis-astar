...
class ApiCollectIdyPpnController extends Controller
{
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'customer_fax' => 'required|string|min:1|max:15',
    ...
    public function massAssignProcess(Request $request)
    {
        ...
        try {
            ...
            CollectIdyPpn::whereIn('no_sr', $request->sr_data)->update([
                'bill_status' => 3,
                'assign_to' => $request->kode_pegawai,
                'assign_by' => $request->assign_by,
            ]);

            $query = CollectIdyPpn::whereIn('no_sr', $request->sr_data)->get();
