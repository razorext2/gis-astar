...
final class SalesTable extends PowerGridComponent
{
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Order Customer', 'customer_make_order')
                ->hidden(isHidden: true, isForceHidden: true),
    ...
    public function filters(): array
    {
        $filters = [
            ...
            Filter::select('customer_make_order', 'tb_sales.customer_make_order')
                ->dataSource([
                    ['name' => 'Sudah Order', 'value' => 1],
                    ['name' => 'Belum Order', 'value' => 0],
                ])
                ->optionLabel('name')
                ->optionValue('value'),
