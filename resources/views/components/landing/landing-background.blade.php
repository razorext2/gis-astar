<div class="relative">
	<img class="fixed inset-0 -z-50 h-full w-full object-cover opacity-40 dark:opacity-80"
		src="{{ asset('assets/img/hero-bg-light.webp') }}" alt="Background Image" loading="lazy" />
