<nav
    class="border-b border-zinc-200 bg-white p-4 shadow-md dark:border-zinc-800 dark:bg-dark-primary dark:shadow-none md:block lg:p-8">
    <div class="center mx-auto flex max-w-screen-xl flex-wrap items-center justify-between">
        ...
        <button
            class="inline-flex h-10 w-10 items-center justify-center rounded-lg p-2 text-sm text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-zinc-200 md:hidden"
            ...
            <ul class="space-y-4 text-left text-gray-500">
                <li class="flex items-center space-x-3 rtl:space-x-reverse">
                    ...
                    <span class="dark:text-white">Tekan tombol <i
                            class="text-xl font-bold text-black dark:text-gray-50">[Enter]</i>
                ...
                <li class="flex items-center space-x-3 rtl:space-x-reverse">
                    ...
                    <span class="dark:text-white">Tekan tombol <i
                            class="text-xl font-bold text-black dark:text-gray-50">[*]</i>
                        untuk
