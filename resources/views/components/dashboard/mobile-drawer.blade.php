...
<!-- drawer component -->
<div
	class="fixed bottom-12 z-50 mx-auto w-11/12 translate-y-full overflow-y-auto rounded-t-2xl border bg-white transition-transform dark:border-gray-700 dark:bg-[#18181b] md:hidden"
	...
	<div class="grid max-h-96 grid-cols-3 gap-6 overflow-y-auto px-4 pb-[60px] pt-4 lg:grid-cols-4">
		...
		@foreach ($drawerLinks as $item)
			...
			@can($item['permission'])
				<a
					class="{{ $isActive ? 'bg-gray-100 dark:bg-gray-700' : 'dark:bg-[#18181b] bg-white' }} group cursor-pointer rounded-xl p-4 hover:bg-gray-100 dark:hover:bg-gray-600"
