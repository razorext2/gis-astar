<x-landing.layout :title="$title">
    <div class="relative flex min-h-screen flex-col justify-center overflow-hidden md:py-12 lg:py-32" id="Home"
        ...
        <x-landing.header-text>
            ...
            Proses pengambilan gambar akan dilakukan sebanyak <span class="font-bold dark:text-white"> DUA </span> kali
            <br />
            <x-slot name="text">
                Tekan tombol
        ...
        <div class="relative mx-2 mb-5 rounded-lg border border-zinc-200 bg-white/60 p-0 dark:border-zinc-800 dark:bg-dark-primary/70 lg:mx-auto lg:p-4"
            ...
            <form id="photoForm" action="{{ route('photo.registProcess') }}" method="POST"
                ...
                <div class="grid h-auto grid-cols-1 gap-4 lg:w-[900px] lg:grid-cols-3">
                    @csrf
                    <div class="video-container col-span-1 h-auto p-3 text-center lg:col-span-2 lg:p-0"
                        ...
                        <div class="mt-3 inline-flex w-full lg:px-0">
                            <div class="relative w-full">
                                <input
                                    class="peer block w-full appearance-none rounded-lg border border-zinc-200 bg-transparent px-2.5 pb-2.5 pt-4 text-sm text-gray-900 focus:border-blue-600 focus:outline-none focus:ring-0 dark:border-zinc-800 dark:bg-gray-500 dark:text-white"
                                    id="floating_outlined" id="kodePegawai" name="kode_pegawai" type="text"
                        ...
                        <div class="mt-3 inline-flex w-full gap-2" data-aos="fade-right" data-aos-delay="150">
                            <x-landing.button-primary class="w-full" id="capturePhoto" type="button">Start
                                Kamera</x-landing.button-primary>
                            <x-landing.button-confirm class="w-full" type="submit">Upload
                                Photos</x-landing.button-confirm>
                        </div>
                    ...
                    <div class="col-span-1 px-3 pb-3 md:px-3 md:pb-3 lg:col-span-1 lg:p-0" data-aos="zoom-in"
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            <div class="rounded-lg border border-zinc-200 p-2 text-center dark:border-zinc-800 dark:bg-dark-primary"
