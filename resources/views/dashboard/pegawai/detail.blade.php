            ...
            <div class="flex flex-row items-center gap-x-4">
                <div class="max-w-xs">
                    <x-button.link class="w-fit ring-1 ring-red-700 dark:bg-red-800 dark:text-white"
                        href="{{ route('pegawai.index') }}" wire:navigate>
                        <x-slot name="icon">
                ...
                <div class="mb-4 border-b border-gray-200 dark:border-gray-700">
                    <ul class="flex flex-wrap text-center text-sm font-medium" role="tablist">
                        <li>
                            <a class="{{ Route::is('pegawai.detail') ? 'text-red-600 border-b-2 hover:border-gray-300' : 'text-gray-400' }} inline-block rounded-t-lg p-4 hover:text-gray-600 dark:hover:text-gray-300"
                                href="{{ route('pegawai.detail', $pegawai->id) }}">Profile</a>
                        </li>

                        <li>
                            <a class="{{ Route::is('pegawai.attendance') ? 'text-red-600 border-b-2 hover:border-gray-300' : 'text-gray-400' }} inline-block rounded-t-lg p-4 hover:text-gray-600 dark:hover:text-gray-300"
                        ...
                        <li>
                            <a class="{{ Route::is('pegawai.timeline') ? 'text-red-600 border-b-2 hover:border-gray-300' : 'text-gray-400' }} inline-block rounded-t-lg p-4 hover:text-gray-600 dark:hover:text-gray-300"
                                href="{{ route('pegawai.timeline', $pegawai->kode_pegawai) }}">Timeline</a>
                        </li>

                        @if ($pegawai->userRelasi->hasRole('Collector'))
                            <li>
                                <a class="{{ Route::is('pegawai.collectors') ? 'text-red-600 border-b-2 hover:border-gray-300' : 'text-gray-400' }} inline-block rounded-t-lg p-4 hover:text-gray-600 dark:hover:text-gray-300"
                        ...
                        @if ($pegawai->userRelasi->hasRole(['Sales', 'Sales-JKT', 'Sales-PKU', 'Sales-IDY', 'Sales-Agrotec', 'Kurir-Bank']))
                            <li>
                                <a class="{{ Route::is('pegawai.sales') ? 'text-red-600 border-b-2 hover:border-gray-300' : 'text-gray-400' }} inline-block rounded-t-lg p-4 hover:text-gray-600 dark:hover:text-gray-300"
