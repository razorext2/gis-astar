...
@section('menus')
    <div class="space-y-4" id="attendance-accordion-icon" data-accordion="collapse">
        ...
        <div class="overflow-hidden rounded-3xl border border-white/30 bg-white/70 shadow-xl backdrop-blur-xl dark:border-white/10 dark:bg-zinc-900/60">
            <h2 id="attendance-accordion-heading-1">
                <button type="button"
                    ...
                    <div class="flex items-center gap-4">
                        <div class="flex h-10 w-10 items-center justify-center rounded-xl bg-green-500/10 text-green-600 dark:bg-green-500/20 dark:text-green-400">
                    ...
                    <x-icons.carred-down data-accordion-icon class="h-5 w-5 text-gray-400 transition-transform duration-300" />
                </button>
            </h2>
            <div id="attendance-accordion-body-1" aria-labelledby="attendance-accordion-heading-1" class="transition-all duration-500">
                <div class="border-t border-white/20 p-6 dark:border-white/5">
        ...
        <div class="overflow-hidden rounded-3xl border border-white/30 bg-white/70 shadow-xl backdrop-blur-xl dark:border-white/10 dark:bg-zinc-900/60">
            ...
            <div id="attendance-accordion-body-2" class="hidden transition-all duration-500" aria-labelledby="attendance-accordion-heading-2">
                <div class="border-t border-white/20 p-6 dark:border-white/5">
                    <div class="overflow-hidden rounded-2xl border border-white/20 bg-white/30 dark:border-white/5 dark:bg-black/10">
