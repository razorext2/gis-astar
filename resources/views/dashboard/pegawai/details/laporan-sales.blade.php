        ...
        <div class="grid grid-cols-1 gap-2 lg:grid-cols-2 lg:gap-4">
                ...
                <div
                    ...
                    <form id="dateForm" action="{{ route('pegawai.sales', ['pegawai' => $pegawai->kode_pegawai]) }}"
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <h3 class="text-sm font-bold text-gray-800 dark:text-white uppercase tracking-wider">Filter Laporan Sales</h3>
                        </div>
            ...
            <div
                ...
                <div class="relative overflow-hidden pl-2">
                    <ol class="relative ml-4 border-l-2 border-dashed border-gray-200 dark:border-gray-700" id="salesContent">
                                ...
                                <li class="relative mb-10 last:mb-0 ml-8 transition-all hover:translate-x-1">
                                    ...
                                    <div class="flex flex-col gap-1">
                                        <h3 class="flex flex-wrap items-center gap-2 text-sm font-bold text-gray-900 dark:text-white">
                                            <a class="group flex items-center gap-1" href="{{ route('sales.show', $data->id) }}" target="_blank">
                                            ...
                                            @php
                                                $statusConfigs = [
                                                    0 => ['label' => 'Unapproved', 'class' => 'bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400'],
