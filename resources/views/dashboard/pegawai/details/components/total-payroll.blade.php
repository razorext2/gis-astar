        ...
        <tbody>
            ...
            @foreach ($allowances as $data)
                ...
                <tr>
                    ...
                    <td class="!text-right text-green-500">+
                        {{ Number::currency($data->allowance_fee ?? 0, 'IDR', 'id') }}</td>
                    <td class="!text-right">-</td>
                    <td class="!text-right">{{ Number::currency($total ?? 0, 'IDR', 'id') }}</td>
            ...
            @foreach ($deductions as $data)
                ...
                <tr>
                    ...
                    <td class="!text-right text-red-500">-
                        {{ Number::currency($data->deduction_fee ?? 0, 'IDR', 'id') }}</td>
                    <td class="!text-right">{{ Number::currency($total ?? 0, 'IDR', 'id') }}</td>
                ...
                topStart: {
                    buttons: [{
                        ...
                        customize: function(win) {
							...
							<div class="p-3 m-2 border border-zinc-200 rounded-xl">
								...
								<div class="text-left py-2 border border-zinc-200 px-1">
									<table class="w-full">
										<tr>
