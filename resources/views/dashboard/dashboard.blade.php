...
@section('content')
    ...
    <div class="flex flex-col">
        ...
        @php
            $showQuickActions = auth()->user()->can('spk-create') || auth()->user()->can('invoice-list') || auth()->user()->can('spk-validate') || auth()->user()->can('point-redeem');
            $showRecentSpk = auth()->user()->can('spk-list');
            $showRightColumn = auth()->user()->can('invoice-list') || auth()->user()->can('technician-list') || auth()->user()->can('point-approve');
        @endphp
        ...
        <div class="mb-6 flex flex-col items-stretch lg:grid lg:grid-cols-3 lg:gap-x-4">
        ...
        <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
            ...
            @if($showRightColumn)
            <div class="flex flex-col gap-4 {{ $showRecentSpk ? '' : 'lg:col-span-3 lg:flex-row lg:items-start lg:[&>*]:flex-1' }}">
                @can('invoice-list')
                <div class="flex-1">
