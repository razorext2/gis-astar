...
@section('content')
	<div
		...
		<div class="flex flex-row justify-between">
			<div>
				<h2 class="w-full text-lg font-semibold text-gray-900 dark:text-white">Buat tim baru</h2>
				<p class="text-md text-gray-600 dark:text-gray-300"> Silahkan isi data tim baru </p>
			</div>
