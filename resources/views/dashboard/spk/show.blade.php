...
@section('content')
    <div
        class="flex flex-col gap-4 rounded-xl bg-white px-3 py-2 shadow-md ring-1 ring-gray-200 dark:bg-dark-primary dark:shadow-none dark:ring-gray-700 lg:p-6">
        <div class="flex flex-row items-center gap-2 lg:gap-4">
            ...
            <div>
                <h2 class="text-xl font-semibold text-gray-900 dark:bg-dark-primary dark:text-white">
                    Detail SPK {{ $spk->nomor_order }} <span class="text-sm uppercase italic">( {{ $spk->tipe_tagihan }}
                        )</span>
                </h2>
