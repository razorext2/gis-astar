...
@section('content')
    ...
    <div class="relative grid grid-cols-1 gap-6">
        ...
        <div
            class="relative grid grid-cols-1 gap-2 rounded-xl border border-zinc-200 bg-white/60 py-2 shadow-md backdrop-blur-md dark:border-zinc-800 dark:bg-dark-primary/60 dark:shadow-none lg:p-6">
