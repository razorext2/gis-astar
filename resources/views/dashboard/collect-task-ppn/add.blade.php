...
@section('content')
    <div class="rounded-xl border border-zinc-200 p-4 shadow-md dark:border-zinc-800 dark:shadow-none sm:p-6"
        x-bind:class="dynamicBg ?
            'bg-glass-light dark:bg-glass-dark border-glass-border-light dark:border-glass-border-dark backdrop-blur-md shadow-sm' :
            'bg-white dark:bg-dark-primary border-zinc-200 dark:border-zinc-800 shadow-sm'">
        <header class="flex items-center">
            <x-button.danger class="my-auto me-4 max-h-10" href="{{ route('collect-task-ppn.index') }}" wire:navigate>
        ...
        <form class="mt-4" id="collect-task-ppn" method="POST">
            ...
            <div class="relative inline-flex w-full gap-4">
                <x-button.primary id="store" type="button">
                    <x-slot name="icon">
                        <x-icons.angle-right class="h-5 w-5 text-white" />
                    </x-slot>
                    Submit
                </x-button.primary>
                ...
                <x-button.danger id="no_sr_reset" type="button">
                    <x-slot name="icon">
                        <x-icons.close class="h-5 w-5 text-white" />
                    </x-slot>
                    Reset
                </x-button.danger>
            </div>
