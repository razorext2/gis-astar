			...
			<div
				...
				<div class="w-full">
					<header class="flex flex-row">
						...
						<form id="add" action="{{ route('collect-task-ppn.index') }}"></form>
						<x-button.danger class="my-auto me-4 max-h-10" id="back-button" form="add" type="submit">
							<x-slot name="icon">
						...
						<div
							...
							<p class="text-navy-700 pt-1.5 text-base font-medium dark:text-white">
								...
								@elseif ($bill_status == 1)
									<span
										class="rounded-lg bg-blue-100 px-4 py-2 text-sm font-medium text-blue-800 ring-1 ring-gray-300 dark:bg-blue-900 dark:text-blue-300 dark:ring-gray-700">
										Tagihan berjalan.
									</span>
								...
								@else
									<span
										class="rounded-lg bg-red-100 px-4 py-2 text-sm font-medium text-red-800 ring-1 ring-gray-300 dark:bg-red-900 dark:text-red-300 dark:ring-gray-700">
										Tagihan tertunda
									</span>
								@endif
...
@push('script')
	...
	@vite('resources/js/pages/collect-task-ppn/detail.js')
@endpush
