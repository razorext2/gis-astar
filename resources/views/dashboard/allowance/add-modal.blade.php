			...
			<div class="p-4 md:p-5">
				<div class="mb-4 grid grid-cols-2 gap-4">
					...
					<div class="col-span-2">
						<label class="mb-2 block text-sm font-medium text-gray-900 dark:text-white" for="allowance_name_add">Name</label>
						<input
					...
					<div class="col-span-2 sm:col-span-1">
						<label class="mb-2 block text-sm font-medium text-gray-900 dark:text-white" for="allowance_type_add">Type</label>
						<select
					...
					<div class="col-span-2 sm:col-span-1">
						<label class="mb-2 block text-sm font-medium text-gray-900 dark:text-white" for="allowance_fee_add">Nilai</label>
						<input
							class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-600 focus:ring-blue-600 dark:border-gray-500 dark:bg-gray-600 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500"
					...
					<div class="col-span-2">
						<label class="mb-2 block text-sm font-medium text-gray-900 dark:text-white" for="allowance_period_add">
							Periode</label>
...
@push('script')
	<script type="module">
		...
		$('#store-allowance').click(function(e) {
			...
			// Ajax call
			$.ajax({
				url: `${APP_URL}/dashboard/pegawai/allowances`,
				type: "POST",
				cache: false,
				data: {
