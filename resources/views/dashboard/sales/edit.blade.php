{{-- Goal: Edit Sales Report Page, Livewire: - (uses native js), Alpine: - --}}
    ...
    <div class="grid w-full gap-4 rounded-xl border border-zinc-200 p-4 shadow-md dark:border-zinc-800 dark:shadow-none sm:p-6"
        ...
        <div class="w-full">
            <header class="flex items-center">
                <x-button.danger id="back-form" type="submit" class="my-auto me-4 max-h-10" wire:navigate
        ...
        <div class="w-full">
            ...
            <div class="grid gap-4 md:grid-cols-2" id="laporan-content">
                ...
                <div class="col-span-2 w-full lg:col-span-1">
                    <x-input.basic id="employee_name" name="employee_name" value="{{ $data->pegawaiRelasi->name }}"
                        readonly>
                        Nama Pegawai
                    </x-input.basic>
                </div>
                ...
                <div class="col-span-2 w-full">
                    <x-input.basic id="lokasi" name="lokasi" value="{{ $data->lokasi }}" placeholder="Jl. XXX, XXX, XXX"
                        required>
                        Alamat Customer
                    </x-input.basic>
                ...
                <input class="w-full rounded-lg border border-zinc-200 bg-gray-400 p-2.5 text-sm text-gray-900"
                    id="longitude" name="longitude" type="hidden" value="{{ $data->longitude }}" readonly>

                <input class="w-full rounded-lg border border-zinc-200 bg-gray-400 p-2.5 text-sm text-gray-900"
                    id="latitude" name="latitude" type="hidden" value="{{ $data->latitude }}" readonly>
