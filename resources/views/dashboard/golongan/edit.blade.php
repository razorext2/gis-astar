{{-- Goal: Edit Golongan Form Page, Livewire: -, Alpine: - --}}
                        ...
                        <div class="my-4 grid gap-6 sm:gap-6 md:grid-cols-2">
                            <div class="w-full">
                                ...
                                <input
                                    ...
                                    value="{{ old('nama_divisi', $golongan->nama_golongan ?? '') }}"
                            ...
                            <div class="w-full">
                                ...
                                <input
                                    ...
                                    value="{{ old('alias', $golongan->alias ?? '') }}" placeholder="Alias" required="">
                            </div>
                        </div>
                                    ...
                                    <div class="grid gap-2 py-4 sm:flex md:gap-4">
                                        ...
                                        <div class="w-full sm:flex-1">
                                            ...
                                            <input
                                                ...
                                                name="jam_masuk_{{ strtolower($day) }}" type="time"
                                        ...
                                        <div class="w-full sm:flex-1">
                                            ...
                                            <input
                                                ...
                                                name="jam_keluar_{{ strtolower($day) }}" type="time"
