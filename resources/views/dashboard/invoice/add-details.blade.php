	...
	<div
		...
		<div>
			...
			<p class="mt-0.5 text-base text-gray-600 dark:text-gray-400">
				Cari terlebih dahulu invoice yang ingin ditambah berdasarkan <span class="font-semibold text-green-500">Nomor Faktur
					Pajak</span>
			</p>
		</div>
...
@endsection
@push('script')
	@vite(['resources/js/pages/invoice/create.js'])
@endpush
