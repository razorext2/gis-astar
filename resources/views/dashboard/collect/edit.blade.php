...
@section('content')
    <div
        class="grid w-full gap-6 rounded-xl border border-zinc-200 bg-white/60 p-4 shadow-md backdrop-blur-md dark:border-zinc-800 dark:bg-dark-primary/60 dark:shadow-none sm:p-6">
                                ...
                                @foreach ($data->photoCollectRelasi as $photo)
                                    <div class="relative me-2 flex-none items-center gap-4">
                                        <img class="h-36 w-36 rounded-xl border object-cover" id="documentations"
                                            ...
                                            data-url="{{ asset($photo->photourl) }}" src="{{ asset($photo->photourl) }}"
