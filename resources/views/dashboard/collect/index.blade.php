...
@section('content')
    ...
    <div class="relative grid grid-cols-1 gap-4">
        ...
        <div
            ...
            <div class="hidden items-center lg:flex">
                <ul class="flex flex-wrap gap-6 text-sm font-medium">
                    <li>
                        <a class="{{ Route::is('collect.index') ? 'text-red-600 border-b border-gray-400' : 'text-gray-600 dark:text-gray-400' }} inline-block rounded-t-lg py-2 hover:text-red-600 dark:hover:text-red-600"
                            wire:navigate href="{{ route('collect.index') }}">Belum Dilengkapi</a>
                    </li>
                    <li>
                        <a class="{{ Route::is('collect.submitted') ? 'text-red-600 border-b border-gray-400' : 'text-gray-600 dark:text-gray-400' }} inline-block rounded-t-lg py-2 hover:text-red-600 dark:hover:text-red-600"
                            wire:navigate href="{{ route('collect.submitted') }}">Diajukan</a>
                    </li>
                    <li>
                        <a class="{{ Route::is('collect.revision') ? 'text-red-600 border-b border-gray-400' : 'text-gray-600 dark:text-gray-400' }} inline-block rounded-t-lg py-2 hover:text-red-600 dark:hover:text-red-600"
                            wire:navigate href="{{ route('collect.revision') }}">Perlu revisi</a>
                    </li>
                    <li>
                        <a class="{{ Route::is('collect.approved') ? 'text-red-600 border-b border-gray-400' : 'text-gray-600 dark:text-gray-400' }} inline-block rounded-t-lg py-2 hover:text-red-600 dark:hover:text-red-600"
                            wire:navigate href="{{ route('collect.approved') }}">Disetujui</a>
                    </li>
                    <li>
                        <a class="{{ Route::is('collect.rejected') ? 'text-red-600 border-b border-gray-400' : 'text-gray-600 dark:text-gray-400' }} inline-block rounded-t-lg py-2 hover:text-red-600 dark:hover:text-red-600"
            ...
            <div class="lg:hidden" id="sub-navbar" x-data="{ open: false }">
                ...
                <div class="mt-2 grid w-full gap-2 md:mt-4 md:gap-4" x-show="open" x-transition>
                    <ul class="rounded-lg bg-white text-gray-700 shadow dark:bg-gray-800 dark:text-gray-200">
                        <li>
                            <a class="{{ Route::is('collect.index') ? 'text-red-600 border-b border-gray-400' : 'text-gray-600 dark:text-gray-400' }} will-change-transformduration-300 inline-block w-full rounded-lg border-none p-3 text-sm transition-all ease-in-out hover:scale-105 hover:dark:bg-gray-500"
                                href="{{ route('collect.index') }}">Belum Dilengkapi</a>
                            </a>
                        </li>
                        <li>
                            <a class="{{ Route::is('collect.submitted') ? 'text-red-600 border-b border-gray-400' : 'text-gray-600 dark:text-gray-400' }} inline-block w-full rounded-lg border-none p-3 text-sm transition-all duration-300 ease-in-out will-change-transform hover:scale-105 hover:dark:bg-gray-500"
                                href="{{ route('collect.submitted') }}">Diajukan</a>
                        </li>
                        <li>
                            <a class="{{ Route::is('collect.revision') ? 'text-red-600 border-b border-gray-400' : 'text-gray-600 dark:text-gray-400' }} inline-block w-full rounded-lg border-none p-3 text-sm transition-all duration-300 ease-in-out will-change-transform hover:scale-105 hover:dark:bg-gray-500"
                                href="{{ route('collect.revision') }}">Perlu revisi</a>
                        </li>
                        <li>
                            <a class="{{ Route::is('collect.approved') ? 'text-red-600 border-b border-gray-400' : 'text-gray-600 dark:text-gray-400' }} inline-block w-full rounded-lg border-none p-3 text-sm transition-all duration-300 ease-in-out will-change-transform hover:scale-105 hover:dark:bg-gray-500"
                                href="{{ route('collect.approved') }}">Disetujui</a>
                        </li>
                        <li>
                            <a class="{{ Route::is('collect.rejected') ? 'text-red-600 border-b border-gray-400' : 'text-gray-600 dark:text-gray-400' }} inline-block w-full rounded-lg border-none p-3 text-sm transition-all duration-300 ease-in-out will-change-transform hover:scale-105 hover:dark:bg-gray-500"
        ...
        <div class="flex h-auto items-center justify-center">
            <div
                class="grid w-full grid-cols-2 gap-2 rounded-xl bg-white p-2 shadow-md ring-1 ring-gray-200 dark:bg-dark-primary dark:shadow-none dark:ring-gray-700 md:gap-4 md:p-6">
