                ...
                <div class="grid gap-2 md:grid-cols-2">
                    ...
                    <div
                        ...
                        <p class="text-navy-700 pt-1.5 text-base font-medium dark:text-white">
                            ...
                            @if ($status == 0)
                                <span
                                    class="rounded-xl bg-yellow-100 px-4 py-2 text-sm font-medium text-yellow-800 ring-1 ring-zinc-200 dark:bg-yellow-900 dark:text-yellow-300 dark:ring-zinc-800">
                                    Sedang diajukan.
                                </span>
                            @elseif ($status == 1)
                                <span
                                    class="rounded-xl bg-green-100 px-4 py-2 text-sm font-medium text-green-800 ring-1 ring-zinc-200 dark:bg-green-900 dark:text-green-300 dark:ring-zinc-800">
                            ...
                            @elseif($status == 4)
                                <span
                                    class="rounded-xl bg-red-100 px-4 py-2 text-sm font-medium text-yellow-800 ring-1 ring-zinc-200 dark:bg-yellow-900 dark:text-yellow-300 dark:ring-zinc-800">
