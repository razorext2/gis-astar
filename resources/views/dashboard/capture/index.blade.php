...
@section('content')
    <div class="relative rounded-xl bg-white p-0 shadow-md ring-1 ring-zinc-200 dark:bg-dark-primary/70 dark:shadow-none dark:ring-zinc-800 lg:max-w-screen-lg lg:p-4"
        ...
        <div class="grid h-auto w-full grid-cols-1 lg:grid-cols-3 lg:gap-4">
            ...
            <div class="video-container h-auto p-3 text-center lg:col-span-2 lg:p-0" data-aos="zoom-in" data-aos-delay="100">
                <div class="relative h-[30rem] w-full">
                    <div class="relative h-full w-full overflow-hidden rounded-lg ring-1 ring-zinc-200 dark:ring-zinc-800"
                    ...
                    <canvas class="absolute left-0 top-0 flex h-full w-full rounded-xl object-cover p-0"
                        id="canvas"></canvas>
                </div>
            ...
            <div class="col-span-1 px-3 pb-3 md:px-3 md:pb-3 lg:col-span-1 lg:p-0" data-aos="zoom-in" data-aos-delay="100">
                <div class="mb-4 rounded-lg p-2 text-center ring-1 ring-zinc-200 dark:bg-dark-primary dark:ring-zinc-800"
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-1">
                    ...
                    <div class="relative flex w-full flex-col gap-6 rounded-lg md:flex-row lg:flex-col lg:gap-0"
                        ...
                        <div class="h-full w-full rounded-lg md:rounded-lg lg:w-full lg:object-fill">
                            <img class="h-60 w-full rounded-lg object-cover ring-1 ring-zinc-200 dark:ring-zinc-800 md:h-auto lg:h-full lg:object-fill"
                                id="canvLogo" src="{{ asset('assets/img/noImage.webp') }}" alt="">
                            <canvas
                                class="absolute left-0 top-0 h-60 w-full rounded-lg object-cover ring-1 ring-zinc-200 dark:ring-zinc-800 md:h-full lg:h-full"
                                id="canvAttend"></canvas>
                        </div>
                    </div>

                    <div class="relative flex h-auto w-full flex-col rounded-lg p-4 leading-normal ring-1 ring-zinc-200 dark:ring-zinc-800 lg:justify-between"
                        data-aos="fade-left" data-aos-delay="100">
                        <div id="pegawaiKosong">
                            <ul class="space-y-4 text-left text-gray-500 dark:text-white">
                                ...
                                <li class="flex items-center space-x-3 rtl:space-x-reverse">
                                    ...
                                    <span>Kode Pegawai: {{ Auth::user()->kode_pegawai }}<input id="kode_pegawai"
                                            name="kode_pegawai" type="hidden" value="{{ Auth::user()->kode_pegawai }}">
                                    </span>
                                </li>
                                <li class="flex items-center space-x-3 rtl:space-x-reverse">
                                    <svg class="h-3.5 w-3.5 flex-shrink-0 text-green-500" aria-hidden="true"
