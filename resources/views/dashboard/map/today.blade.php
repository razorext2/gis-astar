...
@section('content')
    ...
    <div class="flex flex-col gap-6">
        {{-- Absensi Masuk --}}
        <div class="flex w-full flex-col gap-5 rounded-3xl border border-zinc-200 bg-white/70 p-5 shadow-sm backdrop-blur-md dark:border-zinc-800 dark:bg-zinc-900/70 md:p-7">
            <div class="flex items-center gap-3 border-b border-zinc-100 pb-5 dark:border-zinc-800/50">
                ...
                <div>
                    ...
                    <p class="text-xs font-bold uppercase tracking-widest text-zinc-500 dark:text-zinc-400">{{ $date }}</p>
                </div>
            </div>
