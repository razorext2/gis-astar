    ...
    <div class="flex flex-col gap-5">
        ...
        <div class="flex flex-col items-stretch gap-4 lg:flex-row">
            ...
            <div
                ...
                <div class="absolute -right-12 -top-12 h-44 w-44 rounded-full blur-3xl transition-transform duration-1000 group-hover:scale-150 dark:bg-red-900/10"
                    x-bind:class="dynamicBg ?
                        'bg-glass-light dark:bg-glass-dark border-glass-border-light dark:border-glass-border-dark backdrop-blur-md shadow-sm' :
                        'bg-white dark:bg-dark-primary border-zinc-200 dark:border-zinc-800 shadow-sm'">
                </div>
                ...
                <div class="relative z-10 flex flex-col items-center gap-y-4">
                    <div class="rounded-full p-4 dark:border dark:border-zinc-700 dark:bg-dark-secondary/50"
                        x-bind:class="dynamicBg ?
                            'bg-glass-light dark:bg-glass-dark border-glass-border-light dark:border-glass-border-dark backdrop-blur-md shadow-sm' :
                            'bg-white dark:bg-dark-primary border-zinc-200 dark:border-zinc-800 shadow-sm'">
