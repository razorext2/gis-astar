...
@section('content')
	<div class="grid gap-4 lg:grid-cols-2">
		<div
			class="col-span-2 grid w-full grid-cols-2 gap-4 rounded-lg bg-white p-4 shadow-md ring-1 ring-gray-200 dark:bg-dark-primary dark:shadow-none dark:ring-gray-700 sm:p-8">
