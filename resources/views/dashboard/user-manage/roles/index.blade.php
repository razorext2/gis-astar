    ...
    <div class="flex h-auto items-center justify-center">
      <div
        ...
        <div class="col-span-2">
          <table class="dark:text-gray-300 mt-20 w-full text-left text-sm text-gray-500 sm:mt-4" id="table-roles">
  ...
  <script>
    function showDatatables() {
      ...
      function refreshDataTable() {
        ...
        $('#table-roles').DataTable().search('').draw(); // Clear the search and redraw table
      }
    }
    // end datatables //
    ///////////////////
    ...
    function deleteModal() {
      ...
      if (modalEl) {
        ...
        $('#table-roles').on('click', '.delete-btn', function() {
