    ...
    <div class="flex h-auto items-center justify-center">
      <div
        ...
        <div class="col-span-2">
          <table class="dark:text-gray-300 mt-20 w-full text-left text-sm text-gray-500 sm:mt-4" id="table-permissions">
  ...
  <script>
    function showDatatables() {
      ...
      let table = $('#table-permissions').DataTable({
        ...
        dom: `<"absolute top-1 md:left-0 {{ auth()->user()->can('permissions-create') ? 'lg:left-48 right-0' : '' }} mt-14 lg:mt-0 dark:text-white max-w-xs"B><"text-left lg:text-right dark:text-white"l><"relative overflow-x-auto w-full mt-20 lg:mt-4"t><"grid text-center gap-6 lg:grid-cols-2 mt-4 dark:text-white"<"lg:mt-3 lg:text-left"i><"lg:text-right dark:text-gray-900"p>>`,
        buttons: [{
            extend: "csv",
            exportOptions: {
              stripHtml: false
