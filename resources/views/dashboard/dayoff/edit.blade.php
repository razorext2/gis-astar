				...
				<div class="mb-4 grid grid-cols-2 gap-6 sm:mb-5 sm:gap-6">
					...
					<div class="w-full">
						...
						<input
							...
							id="kode_pegawai" name="kode_pegawai" type="text" value="{{ old('kode_pegawai', $data->kode_pegawai) }}"
					...
					<div class="w-full">
						...
						<input class="block w-full rounded-lg border border-gray-300 bg-white p-2.5 text-sm text-gray-900" id="name"
							name="name" type="text" value="{{ old('full_name', $data->pegawaiRelasi->full_name) }}"
							placeholder="Nama karyawan.." readonly>
					...
					<div class="w-full">
						...
						<input
							...
							id="tgl_dari" name="tgl_dari" type="datetime-local" value="{{ old('tgl_dari', $data->tgl_dari) }}" required />
					...
					<div class="w-full">
						...
						<input
							class="block w-full rounded-lg border border-gray-300 bg-white p-2.5 text-sm leading-none text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-700 dark:bg-white dark:text-gray-800 dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500"
							id="tgl_hingga" name="tgl_hingga" type="datetime-local" value="{{ old('tgl_hingga', $data->tgl_hingga) }}"
							required />
