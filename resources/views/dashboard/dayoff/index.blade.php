...
@section('content')
    ...
    <div class="relative grid grid-cols-1 gap-4">
        ...
        <div class="flex h-auto items-center justify-center">
            <div
                class="grid w-full grid-cols-2 gap-2 rounded-xl bg-white p-2 shadow-md ring-1 ring-zinc-200 dark:bg-dark-primary dark:shadow-none dark:ring-zinc-800 md:gap-4 md:p-6">
                ...
                <div class="col-span-2">
                    <x-filter.filter-bar>
                        ...
                        <div class="col-span-2 mx-auto w-full items-center lg:col-span-1">
                            <x-filter.filter-input-select id="dayoff-for" name="dayoff-for" :options="[
                                'Izin' => 'Izin',
                                'Sakit' => 'Sakit',
                                'Absen' => 'Absen',
                                'PC' => 'Pulang Cepat',
                        ...
                        <div class="col-span-2 mx-auto w-full items-center lg:col-span-1">
                            <x-filter.filter-input-select id="status" name="status" :options="['0' => 'Diajukan', '1' => 'Diterima', '2' => 'Ditolak', '3' => 'Dibatalkan']"
