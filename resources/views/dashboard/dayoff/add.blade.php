            ...
            <div class="w-full">
                ...
                <form class="mt-4" method="POST">
                    ...
                    <div class="mb-4 grid grid-cols-2 gap-4 sm:mb-5">
                        ...
                        <div class="w-full">
                            ...
                            @else
                                <input
                                    class="block w-full rounded-lg border border-zinc-200 bg-white p-2.5 text-sm text-gray-900"
                                    id="name" name="name" type="text" value="{{ $data->full_name }}" required
                                    readonly>
                            @endif
                        </div>
                        ...
                        <div class="w-full">
                            ...
                            @else
                                <input
                                    class="block w-full cursor-not-allowed rounded-lg border border-zinc-200 p-2.5 text-sm text-gray-900 dark:border-zinc-800 dark:bg-gray-700 dark:text-gray-400 dark:placeholder-gray-400"
                                    id="kode_pegawai" name="kode_pegawai" type="text" value="{{ $data->kode_pegawai }}"
                                    required readonly>
                            @endif
                    ...
                    <div class="mb-4 w-full">
                        ...
                        <p class="mb-2 text-xs text-red-500"> *Lampiran tidak dapat diubah setelah pengajuan diajukan.
                            Lampiran dapat
