        ...
        <div
            ...
            <div class="w-full">
                <header class="flex flex-row">
                    ...
                    <form id="index-collect-idy-ppn" action="{{ route('collect-idy-ppn.index') }}"></form>
                    <x-button.danger class="my-auto me-4 max-h-10" form="index-collect-idy-ppn" type="submit">
                        <x-slot name="icon">
                    ...
                    <h2 class="mt-2 text-lg font-medium text-gray-900 dark:text-white">
                        {{ __('Tambah Surat Jalan (Faktur Pajak)') }}
                    </h2>
                ...
                <form class="mt-4" id="collect-idy-ppn" method="POST">
                    @csrf
                    <div class="mb-4 grid grid-cols-2 gap-6 sm:mb-5 sm:gap-6">

                        <div class="col-span-2 w-full">
                            <x-input.w-button id="no_sr" name="no_sr" placeholder="8 Digit terakhir faktur pajak...">
                        ...
                        <div class="w-full">
                            <x-input.basic id="sales_invoice" name="sales_invoice" placeholder="cth: 148\/ID-P\/XII\/2015-P"
                                required>
                                Nomor Penjualan
                            </x-input.basic>
                        ...
                        <div class="w-full">
                            <x-input.basic id="tax_invoice" name="tax_invoice" placeholder="cth: 011.004-15.44530015"
                                required>
                                Nomor Faktur Pajak
                            </x-input.basic>
                        ...
                        <div class="w-full">
                            <x-input.select id="sr_type" name="sr_type" :options="[
                                ...
                                default-option="Pilih tipe tagihan">
                                <x-slot name="textLabel">
                                    Tipe Tagihan
                                </x-slot>
                            </x-input.select>
                        ...
                        <div class="col-span-2 w-full">
                            <x-input.basic id="customer_recipient" name="customer_recipient" placeholder="Bp. Samsudin"
                                required>
                                Nama Penerima
                            </x-input.basic>
                        ...
                        <div class="hidden">
                            <div class="col-span-2 w-full">
                                <x-input.textarea id="shipping_address" name="shipping_address"
                                    placeholder="Jl. XXX, XXX, XXX">
                                    Alamat Pengiriman
                                </x-input.textarea>
                            ...
                            <div class="w-full">
                                <x-input.phone-number id="customer_telp" name="customer_telp" placeholder="08123456XXXX"
                                    required>
                                    Telepon
                        ...
                        <div class="w-full">
                            ...
                            <x-input.currency id="remaining_bill" name="remaining_bill" placeholder="Rp. XXX.XXX,-"
                                required>
                        ...
                        <div class="w-full">
                            <x-input.currency id="remaining_bill_bsi" name="remaining_bill_bsi"
