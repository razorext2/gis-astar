@extends('dashboard.collect-idy-ppn.index')
@section('subcontent')
    <div class="flex h-auto items-center justify-center">
        <div
            class="grid w-full grid-cols-2 gap-2 rounded-xl border border-zinc-200 bg-white/60 p-4 shadow-md backdrop-blur-md dark:border-zinc-800 dark:bg-dark-primary/60 dark:shadow-none md:gap-4 md:p-6">

            {{-- filter --}}
            <div class="col-span-2 mb-4">
                <x-filter.filter-bar>
                    @can('collect-idy-ppn-approve')
            ...
            <div class="col-span-2" x-data="{ openRow: null }">
                <x-dashboard.table id="dataTable" data-url="{{ route('collect-idy-ppn.showdata') }}?status=on-progress"
                    :tablename="[
                        '0' => '#',
                        '1' => 'Aksi',
                        '2' => 'Tipe',
