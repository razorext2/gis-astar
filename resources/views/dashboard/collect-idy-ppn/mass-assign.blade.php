                ...
                <form id="mass-assign" method="POST">
                    ...
                    <div class="mb-6 mt-4 grid grid-cols-2 gap-6">
                        ...
                        <div class="col-span-2 w-full">
                            ...
                            <div class="autocomplete-collect-idy-ppn-container" id="autocomplete-collect-idy-ppn-container">
                            </div>
                        ...
                        <div class="col-span-2 w-full">
                            ...
                            <p class="mb-2 block text-sm font-medium text-gray-900 dark:text-white"> List FP yang dipilih
                            </p>
                            <div class="grid w-full gap-2" id="selected-container">
                                <x-input.basic id="empty" name="empty" value="Belum ada FP yang dipilih..."
