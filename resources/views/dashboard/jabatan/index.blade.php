...
@section('content')
  <form id="add-jabatan" action="{{ route('jabatan.create') }}"></form>
    ...
    @can('jabatan-create')
      <div class="absolute left-6 top-56 z-10 max-w-xs sm:left-auto sm:right-6 md:top-40 lg:left-6 lg:right-auto lg:top-24">
        <button
          ...
          form="add-jabatan">
          <svg class="dark:fill-white rotate-180" class="icon" xmlns="http://www.w3.org/2000/svg" width="25"
            height="25" viewBox="0 0 1024 1024" fill="#000000" version="1.1">
            <path
    ...
    <div class="flex h-auto items-center justify-center">
      <div
          ...
          <div>
            <div class="relative">
              <div class="pointer-events-none absolute inset-y-0 end-0 top-0 flex items-center pe-3.5">
                <svg class="dark:text-gray-400 h-4 w-4 text-gray-500" aria-hidden="true"
        ...
        <div class="relative col-span-2 md:col-span-2 lg:col-span-1">
          <form id="searchForm" action="" method="get">
            <div class="relative">
              ...
              <div class="absolute inset-y-0 right-24 flex cursor-pointer items-center" id="clearIcon"
                style="display:none;">
                <svg class="h-4 w-4 text-gray-500 hover:text-gray-700" aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                  <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="col-span-2">
          <table class="dark:text-gray-300 mt-20 w-full text-left text-sm text-gray-500 sm:mt-4" id="table-jabatan">
  ...
  <script>
    function showDatatables() {
      ...
      let table = $('#table-jabatan').DataTable({
        ...
        columns: [{
          ...
          {
            data: 'nama_penempatan',
            name: 'nama_penempatan'
          },
          {
        ...
        dom: `<"absolute top-1 md:left-0 {{ auth()->user()->can('jabatan-create') ? 'lg:left-48 right-0' : '' }} mt-14 lg:mt-0 dark:text-white max-w-xs"B><"text-left lg:text-right dark:text-white"l><"relative overflow-x-auto w-full mt-20 lg:mt-4"t><"grid text-center gap-6 lg:grid-cols-2 mt-4 dark:text-white"<"lg:mt-3 lg:text-left"i><"lg:text-right dark:text-gray-900"p>>`,
        buttons: [{
            extend: "csv",
            exportOptions: {
              stripHtml: false
      ...
      function refreshDataTable() {
        ...
        $('#table-jabatan').DataTable().search('').draw(); // Clear the search and redraw table
      }
    }
    // end datatables //
    ///////////////////
    ...
    function deleteModal() {
      ...
      if (modalEl) {
        ...
        $('#table-jabatan').on('click', '.delete-btn', function() {
