			...
			<div class="max-w-xl">
				<header class="flex flex-row">
					<a
						...
						<svg class="h-6 w-6 dark:fill-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" fill="#000000"
							version="1.1">
							<path
				...
				<form class="mt-4" action="{{ route('jabatan.store') }}" method="POST">
					...
					<div class="mb-4 grid gap-6 sm:mb-5 sm:grid-cols-2 sm:gap-6">
						<div class="sm:col-span-2">
							<label class="mb-2 block text-sm font-medium text-gray-900 dark:text-white" for="nama_jabatan">Nama
								Jabatan</label>
							<input
								...
								id="nama_jabatan" name="nama_jabatan" type="text" placeholder="Nama jabatan" required="">
						</div>
						<div class="w-full">
						...
						<div class="w-full">
							<label class="mb-2 block text-sm font-medium text-gray-900 dark:text-white" for="penempatan">Penempatan</label>
							<select
								class="focus:ring-primary-500 focus:border-primary-500 block w-full rounded-lg border border-gray-300 bg-white p-2.5 text-sm text-gray-900"
