{{-- Goal: Display bill details and list of approved collector reports, Livewire: none, Alpine: none --}}
@extends('dashboard.layoutsDash.app')
@section('content')
    <div class="grid gap-4">
        <div class="grid gap-6 rounded-xl border border-zinc-200 p-4 shadow-md dark:border-zinc-800 dark:shadow-none sm:p-6"
            ...
            <div class="grid gap-2 md:grid-cols-2">
                ...
                @if ($data->bill_status == 1 && auth()->user()->can('collect-task-approve'))
