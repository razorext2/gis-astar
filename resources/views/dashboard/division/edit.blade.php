...
@section('content')
    <div class="w-full rounded-xl border border-zinc-200 p-4 shadow-md dark:border-zinc-800 dark:shadow-none sm:p-6 xl:w-6/12 2xl:w-1/3"
                ...
                <div class="mb-4 grid gap-6 sm:mb-5 sm:grid-cols-2 sm:gap-6">
                    <div class="sm:col-span-2">
                        ...
                        <input
                            ...
                            id="kode_divisi" name="kode_divisi" type="text" value="{{ $division->kode_divisi }}"
                    ...
                    <div class="w-full">
                        ...
                        <input
                            ...
                            id="divisi" name="divisi" type="text"
                            value="{{ old('nama_divisi', $division->nama_divisi ?? '') }}" placeholder="Divisi"
                            required="">
                    </div>
                </div>
