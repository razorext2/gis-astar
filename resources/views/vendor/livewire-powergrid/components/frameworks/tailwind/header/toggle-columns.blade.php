@if (data_get($setUp, 'header.toggleColumns'))
    <div class="mt-2 sm:mt-0" x-data="{ open: false }" @click.outside="open = false">
        ...
        <div class="absolute z-10 mt-2 w-56 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none dark:bg-pg-primary-700"
