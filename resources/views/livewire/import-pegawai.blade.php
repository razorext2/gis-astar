...
<div>
    ...
    <x-modal.base-modal show="showModal" id="import-pegawai-modal" title="Import Data Pegawai"
        subtitle="Upload file Excel untuk update data" maxWidth="lg" iconContainerClass="bg-blue-600 shadow-blue-500/20">
        <x-slot name="icon">
            ...
            @if (!$importResult)
                <div x-data="{ isDragging: false }" class="relative">
                    <label for="file-upload"
                        ...
                        <input id="file-upload" x-ref="fileInput" type="file" wire:model="file" accept=".xlsx,.xls"
                            class="hidden" />
                    </label>
