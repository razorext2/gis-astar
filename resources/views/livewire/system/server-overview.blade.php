<div
    ...
    @if (count($servers) > 0)
        <div
            class="mb-1 hidden grid-cols-[220px_1fr_1fr_1fr_68px] gap-4 px-4 text-[11px] font-semibold uppercase tracking-wider text-zinc-400 dark:text-zinc-600 lg:grid">
            <span>Server</span>
            <span>CPU</span>
            <span>Memori</span>
            <span>Disk</span>
        ...
        @foreach ($servers as $server)
            ...
            <div class="group rounded-xl border border-zinc-200 bg-white px-4 py-3.5 transition-colors hover:bg-zinc-50 dark:border-zinc-800 dark:bg-[#09090b] dark:hover:bg-zinc-900"
                    ...
                    @if ($server->is_active)
                        ...
                        <div>
                            <div class="mb-1 flex justify-between text-xs">
                                ...
                                <span class="font-mono text-zinc-700 dark:text-zinc-300" x-show="!loading"
                                    x-text="stats.cpu + '%'"></span>
                ...
                <div class="mt-3 border-t border-zinc-100 pt-3 dark:border-zinc-800">
                    ...
                    <svg viewBox="0 0 {{ $cw }} {{ $ch }}" class="w-full" style="height:160px"
                        preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
                        <defs>
                            <linearGradient id="{{ $gradId }}" x1="0" x2="0" y1="0"
                                y2="1">
                        ...
                        <line x1="0" y1="{{ $pad }}" x2="{{ $cw }}"
                            y2="{{ $pad }}" stroke="#a1a1aa" stroke-width="0.5" stroke-dasharray="6 4"
                            opacity="0.35" />
                            ...
                            <div class="px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                                <div class="sm:flex sm:items-start">
                                    <div class="mt-3 w-full text-center sm:mt-0 sm:text-left">
                                        ...
                                        <p class="mb-6 mt-1 text-sm text-zinc-500">Konfigurasi endpoint API Glances
                                            untuk
                                            monitoring.</p>
                                        ...
                                        <div class="space-y-4">
                                            ...
                                            <div>
                                                <x-input.basic id="api-url" name="api_url" type="url"
                                                    wire:model="api_url" placeholder="http://192.168.1.1:61208"
                                                    required>
                                                    Glances API URL
                                                </x-input.basic>
                                            ...
                                            <div class="pt-2">
                                                <label class="flex cursor-pointer items-center gap-3">
                                                    ...
                                                    <span
                                                        class="text-sm font-medium text-zinc-700 dark:text-zinc-300">Aktifkan
