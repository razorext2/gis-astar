<ol class="flex w-full items-center text-center text-sm font-medium text-gray-500 dark:text-gray-400 sm:text-base">
    <li
        class="after:border-1 {{ $step == 2 || $step == 3 ? 'after:border-blue-600 dark:after:border-blue-500' : 'dark:after:border-zinc-800' }} flex items-center text-blue-600 after:mx-6 after:hidden after:h-1 after:w-full after:border-b dark:text-blue-500 sm:after:inline-block sm:after:content-[''] md:w-full xl:after:mx-10">
        <span
