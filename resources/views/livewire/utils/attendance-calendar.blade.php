<div class="flex flex-col gap-4">
    <div class="w-full">
        <header class="flex flex-col">
            ...
            <p class="text-sm text-gray-700 dark:text-gray-300">
                Informasi absensi pegawai untuk periode yang dipilih. Data ini mencakup clockin dan clockout setiap
                hari.
            </p>
        </header>
    </div>
    ...
    <div
        class="grid grid-cols-7 gap-2 rounded-xl border border-zinc-200 p-4 text-center dark:border-zinc-800 dark:bg-dark-secondary">
        <!-- Nama-nama hari -->
                ...
                <div>
                    <button
                        class="{{ $hasData
                            ...
                            : 'bg-gray-200 text-gray-400 hover:bg-gray-300 dark:bg-transparent dark:text-gray-300' }} h-full w-full cursor-pointer rounded-lg border border-zinc-200 p-2 dark:border-zinc-800"
    ...
    <ul class="w-full space-y-2">
        @if (collect($clockIn)->isNotEmpty())
            @foreach ($clockIn as $row)
                <li
                    class="flex w-full flex-col items-center gap-0 rounded-lg border border-zinc-200 bg-white shadow-md hover:bg-gray-100 dark:border-zinc-800 dark:bg-dark-secondary dark:shadow-none dark:hover:bg-gray-700 sm:gap-2 md:flex-row">
