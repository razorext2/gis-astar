<div>
    ...
    <x-modal.base-modal show="showModal" id="preview-export" title="Preview Data" subtitle="Rincian Export Poin"
        ...
        <div class="flex max-h-96 w-full flex-col gap-4 overflow-y-auto p-1">
            @foreach ($data ?? [] as $row)
                <div
                    class="flex flex-col rounded-xl border border-zinc-100 bg-zinc-50/50 p-4 dark:border-zinc-800 dark:bg-zinc-900/50">
                    ...
                    <div class="py-3">
                        ...
                        <div class="flex max-h-40 flex-col gap-2 overflow-y-auto pr-1">
                            @foreach ($row->point as $point)
                                <div
                                    class="flex flex-col gap-1 rounded-lg border border-zinc-100 bg-white/60 px-3 py-2 shadow-sm dark:border-zinc-800 dark:bg-zinc-800/60">
