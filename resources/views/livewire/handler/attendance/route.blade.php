<div class="flex flex-col gap-4 lg:gap-6 xl:flex-row">
	<div class="relative grow">
		...
		<div class="absolute bottom-4 flex w-full justify-center px-2">
			<button id="snap"
				class="z-40 w-fit rounded-lg bg-blue-400 p-2 font-bold text-white ring-1 ring-gray-200 hover:bg-blue-700 dark:bg-blue-800 dark:text-white dark:ring-gray-700 dark:hover:bg-blue-900">
				Mulai Kamera
			</button>
		</div>
	</div>
