                        ...
                        <div class="flex flex-col gap-5">
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <a href="{{ route('pegawai.detail', $attendance->pegawaiRelasi->id) }}"
                                        target="_blank"
                                        class="group flex items-center gap-1.5 text-lg font-black text-zinc-900 hover:text-emerald-600 dark:text-white dark:hover:text-emerald-400">
                            ...
                            <div class="flex flex-col gap-3">
                                ...
                                <div class="flex items-start gap-3 rounded-2xl bg-zinc-50/50 p-3 dark:bg-zinc-900/30">
                                    <div
                                        class="mt-0.5 flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-emerald-50 text-emerald-600 dark:bg-emerald-950/30 dark:text-emerald-400">
