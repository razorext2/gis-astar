<div class="grid w-full grid-cols-1 gap-y-6">
    ...
    <div class="flex w-full flex-col items-center gap-3 sm:flex-row">
        <div class="grid w-full grid-cols-1 gap-3 sm:grid-cols-2">
            <x-input.select wire:model.live="role" :labels="false" id="role-in" name="role"
        ...
        <div class="hidden shrink-0 items-center gap-2 rounded-2xl border border-emerald-100 bg-emerald-50/50 px-4 py-2 text-xs font-bold text-emerald-700 dark:border-emerald-900/30 dark:bg-emerald-950/20 dark:text-emerald-400 sm:flex">
                ...
                @if ($showModal && $attendance)
                    ...
                    <div class="flex items-center justify-between border-b border-zinc-100 p-5 dark:border-zinc-800/50">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h2 class="text-xl font-black tracking-tight text-zinc-900 dark:text-white">Detail Check-In</h2>
                        ...
                        <div class="flex flex-col gap-5">
                            ...
                            <div class="relative overflow-hidden rounded-2xl border border-zinc-100 dark:border-zinc-800">
                                ...
                                <div class="absolute inset-0 flex items-end bg-gradient-to-t from-zinc-900/50 to-transparent p-4">
                                    <span class="rounded-lg bg-white/20 px-3 py-1 text-xs font-bold text-white backdrop-blur-md">Foto Check-In</span>
                                </div>
                            </div>
                            ...
                            <div class="flex flex-col gap-3">
                                ...
                                <div class="flex items-start gap-3 rounded-2xl bg-zinc-50/50 p-3 dark:bg-zinc-900/30">
                                    <div class="mt-0.5 flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-emerald-50 text-emerald-600 dark:bg-emerald-950/30 dark:text-emerald-400">
                                    ...
                                    <div class="flex flex-1 flex-col gap-1">
                                        ...
                                        <div class="flex flex-wrap items-center gap-3">
                                            <a href="https://www.google.com/maps/search/?api=1&query={{ $attendance->latitude }},{{ $attendance->longitude }}"
                                                target="_blank" class="flex items-center gap-1 text-xs font-bold text-emerald-600 hover:underline dark:text-emerald-400">
