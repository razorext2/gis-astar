...
<div class="w-full rounded-xl p-4 shadow-md ring-1 ring-zinc-200 dark:shadow-none dark:ring-zinc-800 sm:p-6"
        ...
        <header class="mb-6 flex flex-row items-center gap-4 border-b border-zinc-100 pb-4 dark:border-white/5">
            ...
            <div>
                ...
                <p class="text-xs text-gray-500 dark:text-gray-400">
                    {{ __('Konfigurasi detail jabatan baru untuk struktur organisasi.') }}
                </p>
            </div>
        </header>
        ...
        <form wire:submit="save" class="space-y-6">
            ...
            <div class="flex items-center border-t border-zinc-100 pt-4 dark:border-white/5">
                <x-button.success type="submit" wire:loading.attr="disabled">
                    <span wire:target="save" wire:loading.remove>Simpan Data</span>
                    <span wire:target="save" wire:loading>Menyimpan...</span>
                </x-button.success>
            </div>
        </form>
    </div>
