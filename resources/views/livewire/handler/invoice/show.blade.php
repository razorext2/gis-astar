<div class="mb-16 flex flex-col text-gray-800 dark:text-white">
    ...
    <div
        ...
        @forelse ($invoice->details as $detail)
            <div
                class="flex flex-row gap-2 border-b-[1px] border-zinc-200 p-2 transition-all duration-500 ease-in-out hover:scale-[0.99] hover:bg-gray-50 dark:border-zinc-800 dark:ring-zinc-800 hover:dark:bg-dark-secondary lg:gap-6 lg:p-6">
                ...
                <div class="flex grow flex-col gap-1">
                    ...
                    @if (!empty($detail->informasi_pengiriman))
                        <div class="flex flex-col gap-1 border-t-[1px] border-zinc-200 pt-2">
