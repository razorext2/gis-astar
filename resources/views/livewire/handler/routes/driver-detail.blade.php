<div x-data="{
    ...
    initMap() {
        ...
        this.map = L.map('driver-route-map').setView(defaultCoord, 13);
    ...
    <div
        ...
        <div class="flex items-center border-b border-zinc-200 pb-5 dark:border-zinc-800/50">
            <x-button.danger href="{{ route('routes.driver') }}" class="my-auto me-4 max-h-10" wire:navigate>
                ...
                <li class="relative mb-8 ms-8" @click="focusPin({{ $data->id }})">
                    ...
                    <div class="cursor-pointer rounded-2xl border p-3 transition-all duration-200"
                        ...
                        <div class="mb-1 flex flex-wrap items-start justify-between gap-2">
                            <a href="{{ route('driver.show', $data->id) }}" target="_blank"
                            ...
                            @elseif ($data->status = 2)
                                <span
                                    class="rounded-full bg-amber-100 px-2 py-0.5 text-[10px] font-bold text-amber-800 dark:bg-amber-900/30 dark:text-amber-400">Menunggu
                                    Update</span>
                            @else
                                <span
    ...
    <div
        ...
        <div id="driver-route-map" wire:ignore
