...
<div class="flex w-full flex-col gap-4">
    ...
    <div wire:key="create-participant-form"
        class="{{ $showCreateForm ? 'block' : 'hidden' }} transform rounded-xl border border-zinc-200 bg-white p-6 shadow-xl transition-all dark:border-zinc-800 dark:bg-zinc-900 sm:p-8">
