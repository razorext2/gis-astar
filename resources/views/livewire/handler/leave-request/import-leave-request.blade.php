{{-- Goal: Modal UI for importing historical leave data via Excel, Livewire: Handler.LeaveRequest.ImportLeaveRequest, Alpine: file drag-drop --}}
<div>
    {{-- Trigger Button --}}
    ...
    {{-- Modal --}}
    <x-modal.base-modal show="showModal" id="import-leave-request-modal" title="Import Data Cuti Lama"
        subtitle="Upload file Excel untuk mengimport data cuti historis" maxWidth="lg"
            ...
            <div class="rounded-lg border border-amber-200 bg-amber-50/50 p-3 dark:border-amber-900/50 dark:bg-amber-950/30">
                <div class="flex items-center gap-2">
                    ...
                    <span class="text-xs font-medium text-amber-700 dark:text-amber-400">
                        Data yang diimport langsung berstatus <strong>Disetujui</strong>. Pastikan data sudah benar.
                    </span>
                </div>
            </div>
