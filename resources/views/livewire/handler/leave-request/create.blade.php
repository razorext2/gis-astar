<div
    ...
    <form wire:submit.prevent="save" class="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div class="flex flex-col gap-6 lg:col-span-2">
            <div
                class="border-gray-200 dark:border-gray-700 flex flex-col gap-5 rounded-3xl border bg-white/60 p-6 shadow-xl backdrop-blur-xl dark:bg-dark-primary/60">
                ...
                <div class="flex flex-col">
                    ...
                    <textarea wire:model="reason" rows="4"
                        class="focus:ring-primary/50 border-gray-200 dark:border-gray-700 w-full rounded-2xl border bg-white/50 p-4 text-gray-700 placeholder-gray-400 transition-all dark:bg-gray-800/50 dark:text-gray-200"
        ...
        <div class="flex flex-col gap-6">
            {{-- Summary Card --}}
            <div class="bg-primary/5 dark:bg-primary/10 border-primary/20 rounded-3xl border p-6 backdrop-blur-xl">
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <div class="divider my-1 border-t border-gray-200 dark:border-white/5"></div>
                    <div class="flex items-center justify-between text-sm">
            ...
            {{-- Attachment Card --}}
            <div
                class="border-gray-200 dark:border-gray-700 flex flex-col gap-4 rounded-3xl border bg-white/60 p-6 shadow-xl backdrop-blur-xl dark:bg-dark-primary/60">
                ...
                <div class="flex flex-col gap-3">
                    <div
                        class="hover:border-primary/50 border-gray-200 dark:border-gray-700 relative flex flex-col items-center rounded-2xl border-2 border-dashed p-6 text-center transition-all">
