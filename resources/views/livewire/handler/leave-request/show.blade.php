<div
    class="mt-4 flex flex-col gap-6 rounded-xl border border-zinc-200 bg-white p-4 shadow-sm backdrop-blur-xl dark:bg-dark-primary dark:border-zinc-800 md:p-6">
            ...
            <div
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <div class="grid grid-cols-1 gap-3 md:grid-cols-2">
                        <div
                            class="hover:border-primary group flex cursor-pointer items-center justify-between rounded-xl border border-zinc-200 p-3 transition-colors dark:border-zinc-800">
                            <div class="flex items-center gap-3">
