...
<div class="flex flex-col gap-4" x-data="{ showRejectModal: false }">
    ...
    <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
        ...
        <div class="flex flex-col gap-6">
            {{-- Action Card --}}
            @if ($canApprove)
                <div class="rounded-xl border-2 border-red-500/20 bg-white p-6 shadow-md dark:bg-dark-primary"
                    x-bind:class="dynamicBg ?
                        'bg-glass-light dark:bg-glass-dark border-glass-border-light dark:border-glass-border-dark backdrop-blur-md shadow-sm' :
                        'bg-white dark:bg-dark-primary border-zinc-200 dark:border-zinc-800 shadow-sm'">
                    ...
                    <div class="mb-6 space-y-4">
                        ...
                        <button @click="showRejectModal = true"
                            class="dark:hover: flex w-full items-center justify-center gap-2 rounded-xl border border-zinc-200 py-3 text-sm font-bold text-zinc-600 transition-all hover:bg-zinc-50 active:scale-95 dark:border-zinc-700 dark:text-zinc-400"
                            x-bind:class="dynamicBg ?
                                'bg-glass-light dark:bg-glass-dark border-glass-border-light dark:border-glass-border-dark backdrop-blur-md shadow-sm' :
                                'bg-white dark:bg-dark-primary border-zinc-200 dark:border-zinc-800 shadow-sm'">
