...
<div class="mt-4 flex flex-col gap-6" x-data="{ showRejectModal: false }">
    ...
    <div class="flex items-center gap-3">
        <x-button.link wire:navigate href="{{ route('leave-request.approval-center.index') }}"
            ...
            <x-icons.chevron-left class="group-hover:text-red-500 h-5 w-5 text-zinc-500 transition-colors" />
        </x-button.link>
        <div>
        ...
        <div class="flex flex-col gap-6 lg:col-span-2">
            ...
            <div
                ...
                <div class="grid grid-cols-1 gap-8 md:grid-cols-2">
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <div class="space-y-1">
                            ...
                            <div class="flex items-center gap-2">
                                <div class="flex h-8 w-8 items-center justify-center rounded-xl bg-zinc-100 text-xs font-bold dark:bg-zinc-800">
                ...
                <div class="mt-8 space-y-2">
                    ...
                    <div class="rounded-xl border border-zinc-200 bg-zinc-50/50 p-4 text-zinc-700 dark:border-white/5 dark:bg-white/5 dark:text-zinc-300">
                        "{{ $request->reason }}"
                    </div>
                </div>
            </div>
                    ...
                    @foreach ($request->histories as $history)
                        <div class="relative flex gap-4">
                            ...
                            <div class="flex flex-col gap-1">
                                ...
                                @if($history->note)
                                    <p class="mt-1 rounded-xl bg-zinc-50 px-3 py-1.5 text-xs italic text-zinc-600 dark:bg-white/5 dark:text-zinc-400">
                                        "{{ $history->note }}"
                                    </p>
                                @endif
                            </div>
