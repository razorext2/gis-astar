...
<div class="rounded-xl border border-zinc-200 p-4 shadow-md dark:border-zinc-800 lg:p-6"
    ...
    <form class="flex w-full flex-col gap-6" wire:submit.prevent="search">
        <div class="space-y-4">
            ...
            <div>
                <x-input.basic id="nomor_tagihan" name="nomor_tagihan" wire:model="form.nomor_tagihan" type="text"
                    placeholder="Masukkan nomor SR spk..." :labels="true">
                    Nomor SR
                </x-input.basic>
                ...
                <div
                    ...
                    <ul class="list-inside list-disc space-y-0.5">
                        <li>Gunakan <span class="font-semibold text-zinc-700 dark:text-zinc-300">SR Internal</span>
                            untuk tagihan Non PPN</li>
                        <li>Gunakan <span class="font-semibold text-zinc-700 dark:text-zinc-300">SR PPN</span> untuk
                            tagihan PPN</li>
                    </ul>
                </div>
            </div>
        ...
        <div class="flex items-center justify-end gap-3 border-t border-zinc-100 pt-6 dark:border-zinc-800">
            @if ($form->nomor_tagihan)
                <x-button.secondary type="button" id="clear-search" wire:click="clearSearch"
                    wire:loading.attr="disabled" wire:target="clearSearch">
                    <x-slot name="icon">
