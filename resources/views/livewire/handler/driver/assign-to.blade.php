<div class="w-full">
    <form wire:submit="assign" class="grid gap-4 md:grid-cols-2" id="laporan-content">
        ...
        <div class="w-full">
            <x-input.basic id="pt_name" name="pt_name" value="{{ $data->title }}" readonly
        ...
        <div class="col-span-2 w-full">
            <label for="driver" class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">Pilih
                Driver</label>
