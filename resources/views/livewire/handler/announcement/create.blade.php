{{-- Goal: Create form page for announcement, Livewire: Handler\Announcement\Create, Alpine: Quill editor, user search --}}
<div class="w-full space-y-4">
    ...
    x-bind:class="dynamicBg ? 'bg-glass-light dark:bg-glass-dark border-glass-border-light dark:border-glass-border-dark backdrop-blur-md shadow-lg shadow-red-500/10' : 'bg-white dark:bg-dark-primary border-zinc-200 dark:border-zinc-800 shadow-sm'">
        <div class="flex flex-col justify-between gap-4 md:flex-row md:items-center">
            <div class="flex items-center">
                ...
                <div>
                    <h2 class="text-2xl font-bold tracking-tight text-gray-800 dark:text-white">Tambah Pengumuman</h2>
                    <p class="text-sm text-gray-500 dark:text-gray-400">Buat pengumuman baru untuk seluruh atau sebagian
                        karyawan.</p>
                </div>
            </div>
    ...
    <div class="grid grid-cols-1 gap-2 lg:grid-cols-3 lg:gap-4">
        ...
        <div class="space-y-2 lg:col-span-2 lg:space-y-4">
            ...
            <div
                class="group relative overflow-hidden rounded-xl border border-zinc-200 p-6 dark:border-zinc-800"
    x-bind:class="dynamicBg ? 'bg-glass-light dark:bg-glass-dark border-glass-border-light dark:border-glass-border-dark backdrop-blur-md shadow-lg shadow-red-500/10' : 'bg-white dark:bg-dark-primary border-zinc-200 dark:border-zinc-800 shadow-sm'">
                <div
            ...
            <!-- Target Pengumuman -->
            <div
                class="group relative rounded-xl border border-zinc-200 p-6 dark:border-zinc-800"
    x-bind:class="dynamicBg ? 'bg-glass-light dark:bg-glass-dark border-glass-border-light dark:border-glass-border-dark backdrop-blur-md shadow-lg shadow-red-500/10' : 'bg-white dark:bg-dark-primary border-zinc-200 dark:border-zinc-800 shadow-sm'">
