...
@php
    ...
    $colorClasses = match ($color) {
        ...
        'purple' => [
            ...
            'pulse' => 'bg-purple-500',
            'text_color' => 'text-purple-500 dark:text-purple-400',
        ],
        'amber' => [
        ...
        'cyan' => [
            ...
            'pulse' => 'bg-cyan-500',
            'text_color' => 'text-cyan-500 dark:text-cyan-400',
        ],
        'indigo' => [
            ...
            'pulse' => 'bg-indigo-500',
            'text_color' => 'text-indigo-500 dark:text-indigo-400',
        ],
        'teal' => [
            ...
            'pulse' => 'bg-teal-500',
            'text_color' => 'text-teal-500 dark:text-teal-400',
        ],
        default => [
            ...
            'pulse' => 'bg-zinc-500',
            'text_color' => 'text-zinc-500 dark:text-zinc-400',
        ],
    };
@endphp
