<div
	class="flex w-full gap-2 rounded-xl border border-gray-200 bg-white p-4 text-gray-800 dark:border-gray-700 dark:bg-dark-primary dark:text-white lg:block lg:gap-4 xl:p-6">
