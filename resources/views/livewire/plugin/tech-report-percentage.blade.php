<div
    class="flex w-full flex-col gap-6 rounded-3xl border border-white/40 bg-white/60 p-4 shadow-xl backdrop-blur-sm dark:border-zinc-800/50 dark:bg-dark-primary/60 lg:p-6">
