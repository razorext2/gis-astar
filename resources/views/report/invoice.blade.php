<table style="border-collapse: collapse; width: 100%;">
	<thead>
		<tr>
			<th style="font-weight: bold;" colspan="2">{{ $region }}</th>
		...
		<tr style="height: 70px;">
			...
			<th style="width: 120px; border: 1px solid black; text-align: center; font-weight: bold;">No. Penjualan</th>
			...
			<th style="width: 200px; border: 1px solid black; text-align: center; font-weight: bold;">Status Terbaru</th>
	...
	<tbody>
		@foreach ($data as $i => $item)
			<tr>
				...
				<td style="border: 1px solid black;">{{ $item->no_penjualan ?? '-' }}</td>
				...
				<td style="border: 1px solid black;">{{ $item->status_terbaru ?? '-' }}</td>
