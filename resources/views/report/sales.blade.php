<table style="border-collapse: collapse; width: 100%;">
	<thead>
		...
		<tr style="height: 70px;">
			...
			<th style="width: 120px; border: 1px solid black; text-align: center; font-weight: bold;">Nama Sales</th>
			<th style="width: 100px; border: 1px solid black; text-align: center; font-weight: bold;">Dibuat Tgl</th>
			<th style="width: 120px; border: 1px solid black; text-align: center; font-weight: bold;">Judul Laporan</th>
			<th style="width: 120px; border: 1px solid black; text-align: center; font-weight: bold;">Nama Customer</th>
			<th style="width: 100px; border: 1px solid black; text-align: center; font-weight: bold;">No. Telp Customer</th>
			<th style="width: 120px; border: 1px solid black; text-align: center; font-weight: bold;">Lokasi</th>
	...
	<tbody>
		@foreach ($data as $i => $item)
			<tr style="font-weight: bold;">
				...
				<td style="border: 1px solid black; text-align: left;">{{ $item->pegawaiRelasi->full_name ?? '-' }}</td>
				...
				<td style="border: 1px solid black; text-align: left;">{{ $item->customer_name ?? '-' }}</td>
				<td style="border: 1px solid black; text-align: right; font-size: 9px;">{{ $item->customer_telp ?? '-' }}</td>
				<td style="border: 1px solid black; text-align: left;">{{ $item->lokasi ?? '-' }}</td>
				<td style="border: 1px solid black; text-align: left;">{{ strip_tags($item->keterangan) ?? '-' }}</td>
