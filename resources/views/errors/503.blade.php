                ...
                <div class="order-2 space-y-8 text-center lg:order-1 lg:text-left">
                    <div class="space-y-4">
                        ...
                        <p class="mx-auto max-w-md text-lg leading-relaxed text-gray-600 dark:text-gray-400 lg:mx-0">
                            Maaf atas ketidaknyamanannya. Kami sedang melakukan pemeliharaan sistem rutin untuk
                            memberikan layanan yang lebih baik. Kami akan segera kembali!
                        </p>
                    </div>

                    <div class="flex flex-col justify-center gap-4 sm:flex-row lg:justify-start">
                        <x-button.secondary onclick="window.location.reload()"
                            class="flex items-center justify-center gap-2 rounded-2xl border-white/20 bg-blue-600 px-8 py-4 font-bold text-white shadow-lg shadow-blue-500/25 transition-all hover:bg-blue-700">
