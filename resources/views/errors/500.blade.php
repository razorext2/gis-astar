				...
				<div class="flex flex-col justify-evenly md:h-screen md:flex-row md:items-center">
					<div class="mx-auto max-w-screen-xl lg:px-6 lg:py-16">
						<div class="mx-auto max-w-screen-sm">
							...
							<p class="dark:text-white mb-4 text-3xl font-extrabold tracking-tight text-gray-900 md:text-4xl">Internal Server
								Error.</p>
							<p class="dark:text-gray-400 mb-4 text-lg font-light text-gray-500">We are already working to solve the problem.
							</p>
						</div>
					</div>
				</div>
