    ...
    <div class="container mx-auto px-8">
        <div class="grid h-screen md:grid-cols-2">
            ...
            <div class="flex items-center justify-center">
                <img class="w-64 md:w-full" src="{{ asset('assets/img/413.png') }}" alt="403 Image" loading="lazy">
            </div>
