        ...
        <div class="relative w-full max-w-6xl">
            <div class="grid items-center gap-8 rounded-[2.5rem] border border-white/40 bg-white/70 p-8 shadow-2xl shadow-blue-500/10 backdrop-blur-3xl dark:border-zinc-800/50 dark:bg-zinc-900/60 lg:grid-cols-2 lg:p-16">
                ...
                <div class="order-2 space-y-8 text-center lg:order-1 lg:text-left">
                    <div class="space-y-4">
                        ...
                        <p class="mx-auto max-w-md text-lg leading-relaxed text-gray-600 dark:text-gray-400 lg:mx-0">
                            Server menerima respon yang tidak valid dari jaringan. Silakan muat ulang halaman atau coba lagi dalam beberapa saat.
                        </p>
                    </div>
                    
                    <div class="flex flex-col justify-center gap-4 sm:flex-row lg:justify-start">
                        <x-button.link href="{{ url('/') }}" class="flex items-center justify-center gap-2 rounded-2xl bg-blue-600 px-8 py-4 font-bold text-white shadow-lg shadow-blue-500/25 transition-all hover:scale-[1.02] hover:bg-blue-700 active:scale-[0.98]">
                            <x-icons.home class="h-5 w-5" />
                            <span>Kembali ke Beranda</span>
                        </x-button.link>
                        
                        <x-button.secondary onclick="window.location.reload()" class="flex items-center justify-center gap-2 rounded-2xl border-white/20 bg-white/50 px-8 py-4 font-bold shadow-sm transition-all hover:bg-white dark:border-zinc-700 dark:bg-zinc-800/50 dark:hover:bg-zinc-800">
                ...
                <div class="order-1 flex items-center justify-center lg:order-2">
                    <img src="{{ asset('assets/img/500.svg') }}" 
                         alt="502 Bad Gateway" 
