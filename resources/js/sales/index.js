      ...
      html: `
        <div class="w-full">
				<div class="grid gap-2 md:grid-cols-2">
					<div
						class="col-span-2 flex flex-col items-start justify-center rounded-xl border border-gray-200 bg-gray-50 p-3   lg:col-span-1">
					...
					<div
						class="col-span-2 flex flex-col items-start justify-center rounded-xl border border-gray-200 bg-gray-50 p-3  ">
					...
					<div
						...
						<div class="relative me-2 flex-none items-center gap-4 rounded-xl p-2">
				  		<img class="h-52 w-52 rounded-xl object-cover transition duration-300 ease-in-out hover:scale-110" id="documentations" src="${row.photo_collect_relasi[0].photourl}" alt="" onclick="javascript:void(0)" loading="lazy">
						</div>
					</div>
