            ...
            if (data.length > 0) {
              data.forEach((collectTask, index) => {
                ...
                $('#autocomplete-collect-idy-ppn-container').append(`
                  <div class="autocomplete-collect-idy-ppn-item bg-white border border-gray-300 dark:bg-white p-2.5 divide-y w-full ${roundedClass}" data-nosr="${collectTask.no_sr}" data-id="${collectTask.id}">
