    ...
    return Swal.fire({
        ...
        <div class=" min-w-96 text-left">
          ...
          <div class="grid gap-1 md:grid-cols-2 text-left">
            ...
            <div
              class="col-span-2 flex flex-col items-start rounded-xl border border-zinc-200 bg-gray-50 p-3 lg:col-span-1">
          ...
          <div
            ...
            <div
              class="col-span-2 flex flex-col items-start rounded-xl border border-zinc-200 bg-gray-50 p-3">
            ...
            <div
              ...
              <p class="text-gray-800 pt-1.5 text-base font-medium " id="status">
                <span class="rounded-xl bg-yellow-100 px-4 py-2 text-sm font-medium text-yellow-800 ring-1 ring-zinc-200">
                  Sedang diajukan.
                </span>
              </p>
            </div>
