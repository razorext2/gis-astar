      ...
      html: `
        <form id="formExport" class="grid gap-4 !text-left">
          <div class="col-span-2">
            ...
            <input id="tglLaporan" type="date" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Select date">
          </div>

          <div class="col-span-2">
            <label for="statusLaporan" class="block mb-2 text-sm font-medium text-gray-900">Status laporan</label>
            <select id="statusLaporan" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
          ...
          <div class="col-span-2">
            ...
            <select id="tipeTagihan" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
              <option value="">Pilih</option>
