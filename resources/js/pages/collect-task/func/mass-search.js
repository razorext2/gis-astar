                            ...
                            data.forEach((collectTask, index) => {
                                let roundedClass =
                                    index === data.length - 1
                                        ? "rounded-b-lg"
                                        : "";
                                $("#autocomplete-collect-task-container")
                                    .append(`
                  <div class="autocomplete-collect-task-item bg-white border border-zinc-200 dark:bg-white p-2.5 divide-y w-full ${roundedClass}" data-nosr="${collectTask.no_sr}" data-id="${collectTask.id}">
