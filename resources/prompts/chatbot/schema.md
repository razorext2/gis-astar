...
- **tb_announcements**: System announcements (id, title, description, status, file_path, target_type, target_roles, target_users)
- **tb_announcement_reads**: Read status of announcements (id, announcement_id→tb_announcements.id, user_id→users.id, read_at)
